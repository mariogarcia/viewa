...
import org.viewaframework.widget.controller.DetailViewController;
import org.viewaframework.widget.view.delegator.DetailViewDelegator;
...
public abstract class DetailView<D,M> extends AbstractViewContainerDialog{
	...
	/* (non-Javadoc)
	 * @see org.viewaframework.view.AbstractViewContainer#getActionDescriptors()
	 */
	@Override
