...
import viewa.swing.treetable.single.DynamicTreeTableModel;
...
public class DynamicTreeTableTest {
	...
	public class Rating {
		...
		public Integer getViewers(){return this.viewers;}
	...
	@Before
	public void init(){
		ratingList = new ArrayList<Rating>(Arrays.asList(
			new Rating("channel1","Spain",20.2,121213123),
			new Rating("channel2","France",22.1,121213121),
			new Rating("channel3","Spain",22.2,121213123),
			new Rating("channel4","UK",22.2,121213124),
			new Rating("channel5","Spain",22.4,121213124),
			new Rating("channel6","UK",20.2,121213123),
			new Rating("channel7","UK",22.4,121213123),
			new Rating("channel8","France",22.2,121213121),
			new Rating("channel9","UK",22.1,121213123)
		));
		columns = Arrays.asList(
			new DynamicTreeTableColumn("country",0, 100, "Country",true),
			new DynamicTreeTableColumn("channel",1, 100, "Channel",false),			
			new DynamicTreeTableColumn("share",2, 100, "Share",false),
			new DynamicTreeTableColumn("viewers",3, 100, "Viewers",false)
		);
