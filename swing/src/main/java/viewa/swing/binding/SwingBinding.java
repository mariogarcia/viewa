...
import viewa.swing.binding.core.BeanAdapterBinding;
import viewa.swing.binding.core.Binding;
...
public class SwingBinding implements Binding<Object>{
	...
	public <TS> SwingBinding createComboBoxSelectionBinding(JComboBox source,BeanAdapter<TS> target){
		ComboBoxSelectionBinding<JComboBox, TS> binding = 
			new ComboBoxSelectionBinding<JComboBox, TS>(source, target);
		this.bindingList.add(binding);
		return this;
	}
	...
	public <SP,TS,TP> SwingBinding createLabelBinding(JLabel source,Property<SP> sourceProperty,BeanAdapter<TS> target,Property<TP> targetProperty){
		LabelBinding<JLabel, SP, TS, TP> binding = 
			new LabelBinding<JLabel, SP, TS, TP>(source, sourceProperty, target, targetProperty);
		this.bindingList.add(binding);
		return this;
	}
	...
	public <TS> SwingBinding createListSelectionBinding(JList source,BeanAdapter<TS> target){
		ListSelectionBinding<JList, TS> binding =
			new ListSelectionBinding<JList, TS>(source, target);
		this.bindingList.add(binding);
		return this;
	}
	...
	public <TS> SwingBinding createTableSelectionBinding(JTable source,BeanAdapter<TS> target){
		TableSelectionBinding<JTable, TS> binding = 
			new TableSelectionBinding<JTable, TS>(source, target);
		this.bindingList.add(binding);
		return this;
	}
	...
	public <SP,TS,TP> SwingBinding createTextFieldBinding(JTextField source,Property<SP> sourceProperty,BeanAdapter<TS> target,Property<TP> targetProperty){
		TextFieldBinding<JTextField, SP, TS, TP> binding =
			new TextFieldBinding<JTextField, SP, TS, TP>(source, sourceProperty, target, targetProperty);
		this.bindingList.add(binding);
		return this;
	}	
