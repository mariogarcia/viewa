...
import org.viewaframework.view.delegator.DialogViewClosingWindowDelegator;
...
public abstract class AbstractViewContainerDialog extends AbstractViewContainer implements ViewContainerDialog
{
	...
	/* (non-Javadoc)
	 * @see org.viewaframework.view.AbstractViewContainer#getComponentsByName(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.viewaframework.view.ViewContainerDialog#getDialog()
	 */
	...
	/* (non-Javadoc)
	 * @see org.viewaframework.view.AbstractViewContainer#getRootPane()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.viewaframework.view.ViewContainerDialog#setDialog(javax.swing.JDialog)
	 */
