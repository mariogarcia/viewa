...
import viewa.view.ViewContainerLocator;
import viewa.view.ViewContainerLocatorAware;
	...
	implements ViewController<EL,EO>,ViewContainerLocatorAware
{
	...
	/* (non-Javadoc)
	 * @see viewa.controller.ViewController#executeHandler(viewa.view.ViewContainer, java.util.EventObject)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.controller.ViewController#getViewManager()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.controller.ViewController#handleView(viewa.view.ViewContainer, java.util.EventObject)
	 */
	public void handleView(final ViewContainer view, final EO eventObject) throws BackgroundException{ }

	/* (non-Javadoc)
	 * @see viewa.controller.ViewController#postHandlingView(viewa.view.ViewContainer, java.util.EventObject)
	 */
	public void postHandlingView(ViewContainer view, EO eventObject) throws ViewException{ }
	
	/* (non-Javadoc)
	 * @see viewa.controller.ViewController#postHandlingViewOnError(viewa.view.ViewContainer, java.util.EventObject, viewa.controller.BackgroundException)
	 */
	public void postHandlingViewOnError(ViewContainer view, EO eventObject,BackgroundException th) throws ViewException{ }

	/* (non-Javadoc)
	 * @see viewa.controller.ViewController#preHandlingView(viewa.view.ViewContainer, java.util.EventObject)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerLocatorAware#locate(java.lang.Class)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerLocatorAware#locate(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerLocatorAware#locateRootView()
	 */
