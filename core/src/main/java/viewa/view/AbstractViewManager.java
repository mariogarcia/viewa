...
import viewa.annotation.processor.ControllersProcessor;
import viewa.annotation.processor.ListenersProcessor;
...
public abstract class AbstractViewManager implements ViewManager
{
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewManager#addView(viewa.view.ViewContainer, viewa.view.perspective.PerspectiveConstraint)
	 */
