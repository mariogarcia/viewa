...
import viewa.view.event.ViewContainerEvent;
...
public abstract class AbstractViewContainer implements ViewContainer
{
	...
	/* (non-Javadoc)
	 * @see viewa.view.delegator.DelegatorAware#addDelegator(viewa.view.delegator.Delegator)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.model.ViewModelAware#addModelValue(java.lang.String, java.lang.Object)
	 */
	public void addModelValue(String alias, Object object) {
		this.viewModelObjects.put(alias, object);
	}
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerEventControllerAware#addViewContainerListener(viewa.view.ViewContainerEventController)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerEventAware#fireViewClose(viewa.view.ViewContainerEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerEventAware#fireViewFinalUIState(viewa.view.ViewContainerEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerEventAware#fireViewInit(viewa.view.ViewContainerEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerEventAware#fireViewInitBackActions(viewa.view.ViewContainerEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerEventAware#fireViewInitUIState(viewa.view.ViewContainerEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#getActionDescriptors()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ComponentsAware#getComponentByName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ComponentAware#getComponentByName(java.lang.String)
	 */
	public List<Component> getComponentsByName(String name) {
		return this.getNamedComponents().get(name);
	}
	/* (non-Javadoc)
	 * @see viewa.view.ComponentAware#getContainer()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.delegator.DelegatorAware#getDelegators()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#getIconImage()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#getJToolBar()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.core.MessageAware#getMessage(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.core.MessageAware#getMessageBundle()
	 */
	public ResourceBundle getMessageBundle() {
		return messageBundle;
	}
	/* (non-Javadoc)
	 * @see viewa.model.ViewModelAware#getModelValue(java.lang.String)
	 */
	public synchronized Object getModelValue(String alias) {
		return viewModelObjects.get(alias);
	}
	/* (non-Javadoc)
	 * @see viewa.view.ComponentAware#getNamedComponents()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#getTitle()
	 */
	public String getTitle() {
		return title;
	}
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerEventControllerAware#getViewContainerListeners()
	 */
	public List<ViewContainerEventController> getViewContainerListeners() {
		return this.viewContainerEventControllers;
	}	
	/* (non-Javadoc)
	 * @see viewa.controller.ViewControllerAware#getViewControllerMap()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.model.ViewModelAware#getViewModelMap()
	 */
	public Map<String, ViewModel> getViewModelMap() {
		return this.viewModelMap;
	}
	/* (non-Javadoc)
	 * @see viewa.view.delegator.DelegatorAware#removeDelegator(viewa.view.delegator.Delegator)
	 */
	public void removeDelegator(Delegator delegator) {
		this.getDelegators().remove(delegator);
	}
	/* (non-Javadoc)
	 * @see viewa.view.event.ViewContainerEventControllerAware#removeViewContainerListener(viewa.view.event.ViewContainerEventController)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#setActionDescriptors(java.util.List)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.delegator.DelegatorAware#setDelegators(java.util.List)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#setIconImage(java.awt.Image)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#setJToolbar(javax.swing.JToolBar)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.core.MessageAware#setMessageBundle(java.util.ResourceBundle)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#setTitle(java.lang.String)
	 */
	public void setTitle(String title) {
		this.title = title;
	}
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerEventControllerAware#setViewContainerListeners(java.util.List)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.controller.ViewControllerAware#setViewControllerMap(java.util.Map)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.model.ViewModelAware#setViewModelMap(java.util.Map)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#viewFinalUIState()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#viewInitBackActions()
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainer#viewInitUIState()
	 */
