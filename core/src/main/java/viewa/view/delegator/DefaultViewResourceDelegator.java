...
import viewa.util.ChildResourceBundleAware;
import viewa.util.LastModifiedControl;
import viewa.view.ViewContainer;
import viewa.view.ViewManager;
import viewa.view.delegator.converter.ViewResourceBooleanConverter;
import viewa.view.delegator.converter.ViewResourceColorConverter;
import viewa.view.delegator.converter.ViewResourceDimensionConverter;
import viewa.view.delegator.converter.ViewResourceIconConverter;
import viewa.view.delegator.converter.ViewResourceImageConverter;
import viewa.view.delegator.converter.ViewResourcePrimitiveBooleanConverter;
import viewa.view.delegator.converter.ViewResourceStringConverter;
...
public class DefaultViewResourceDelegator implements ViewResourceDelegator {
	...
	/* (non-Javadoc)
	 * @see viewa.view.delegator.ViewResourceDelegator#clearResources(java.lang.Object, java.lang.Class)
	 */
	...
	/**
	 * If no control is defined it returns a viewa.util.LastModifiedControl class.
	 * 
	...
	/**
	 *  This method loads the default converters located in the following package "viewa.view.delegator.converter"
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.delegator.ViewResourceDelegator#setViewResourceConverters(java.util.Map)
	 */
