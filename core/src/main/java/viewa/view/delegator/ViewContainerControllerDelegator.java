...
import viewa.controller.GenericListenerHandler;
import viewa.controller.ListenerProxy;
import viewa.controller.ViewController;
import viewa.view.ViewContainer;
import viewa.view.ViewContainerDialog;
...
public class ViewContainerControllerDelegator implements Delegator {
	...
	/* (non-Javadoc)
	 * @see viewa.view.delegator.ViewContainerControllerDelegator#cleanControllers(viewa.view.ViewContainer)
	 */
	...
	/* (non-Javadoc)
	 * @see viewa.view.ViewContainerControllerDelegator#injectControllers(viewa.view.ViewContainer, java.util.Map)
	 */
