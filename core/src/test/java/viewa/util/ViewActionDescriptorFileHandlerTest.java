...
public class ViewActionDescriptorFileHandlerTest extends TestCase{
	...
	public void setUp() throws Exception {
		...
		mockery.checking(new Expectations(){
			{ atLeast(1).of(view).getActionDescriptors(); will(returnValue(Arrays.asList(
					new ViewActionDescriptor("/rightMenu[@text='rightMenu']"),
					new ViewActionDescriptor("/rightMenu/hide[@text='hide']"),
					new ViewActionDescriptor("/leftMenu[@text='leftMenu']"),
					new ViewActionDescriptor("/leftMenu/other[@text='other']")
			)));}			
		});
	}
