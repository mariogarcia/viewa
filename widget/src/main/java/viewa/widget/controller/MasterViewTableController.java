...
import viewa.controller.AbstractMouseClickController;
...
public abstract class MasterViewTableController<T,D> extends AbstractMouseClickController{
	...
	/* (non-Javadoc)
	 * @see viewa.controller.AbstractViewController#preHandlingView(viewa.view.ViewContainer, java.util.EventObject)
	 */
	@Override
	@SuppressWarnings("unchecked")
